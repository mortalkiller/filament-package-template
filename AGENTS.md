...
Read `docs/package-standard.md`, `docs/development-flow.md`, and `resources/boost/skills/developing-filament-packages/SKILL.md` before package work. Permanent branches are major lines; temporary branches and PRs target the affected major. Releases are immutable tags on verified major commits, without a promotion branch.
